...
class OpenAIProvider implements AnalysisProvider {
  ...
  Future<Result<String>> analyze({required AnalysisRequest request, required String prompt}) async {
    ...
    return Failure(ConfigurationException(message: 'OpenAIProvider logic will be implemented in future tasks.'));
  }
  ...
  @override
  List<String> supportedMediaTypes() => ['image']; // Simplified for MVP

  @override
  String providerName() => 'OpenAI';

  @override
  String modelVersion() => 'gpt-4.5-turbo';
}
